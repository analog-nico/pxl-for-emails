            ...
            return stringReplaceAsync.seq(
                ...
                BPromise.coroutine(function *(match, p1, link, p3) {
                    ...
                    if (referToOpenTrackingPxl && !openTrackingPxl) {
                        ...
                        let createdPxl = yield this.options.pxl.createPxl(getMetadataForOpenTracking(metadata))
                        openTrackingPxl = createdPxl.pxl
                    ...
                    if (!clickPxls[link]) {
                        ...
                        metadataToUse = _.assign({ link: linkToUse }, fullMetadata)
                        ...
                        clickPxl = clickPxls[link].clickPxl
